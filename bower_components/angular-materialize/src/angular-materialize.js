(function (angular) {
    angular.module("ui.materialize", ['ui.materialize.ngModel', 'ui.materialize.collapsible', "ui.materialize.toast", "ui.materialize.sidenav", "ui.materialize.material_select", "ui.materialize.dropdown", "ui.materialize.inputfield", "ui.materialize.input_date", "ui.materialize.tabs", "ui.materialize.pagination", "ui.materialize.modal"]);
    ...
    angular.module("ui.materialize.tabs", [])
        .directive("tabs", ['$compile', '$timeout', function($compile, $timeout){
            return {
                link: function (scope, element, attrs) {
            ...
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    if (element.is("select")) {
                        if (Modernizr.touch){
                          element.addClass('browser-default');
                        }
                        ...
                        $timeout(function () {
                            ...
                            if(currValue !== undefined){
                              element.find("option[value='"+currValue+"']").attr( 'selected', true );
                            }
        ...
        .directive('inputField', ["$compile", "$timeout", function ($compile, $timeout) {
            return {
                ...
                link: function (scope, element) {
                    $timeout(function () {
                        angular.element(element).find("input, textarea").change();
                        angular.element(element).find('input, textarea').characterCounter();
                        if (Modernizr.touch) {

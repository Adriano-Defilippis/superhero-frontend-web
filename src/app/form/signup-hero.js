...
export default function SignupHeroController (
    ...
    self.moreInfo = false;
    self.additionalVatInfo = false;
    self.formTitle = "Diventa supereroe!";
    self.zonesPanel = "app/form/zones.html";
    self.submitButton = "Invia candidatura";
    self.paper = true;
    ...
    self.submitForm = function(isValid){
      ...
      if (isValid) {
        /*if (self.imgUploader.queue.length < 1) {
            NotifyService.modal({ title: "Attenzione", content: "È obbligatorio inserire una foto per inviare la candidatura" });
            isValid = false;
            self.isLoading = false;
        }*/
